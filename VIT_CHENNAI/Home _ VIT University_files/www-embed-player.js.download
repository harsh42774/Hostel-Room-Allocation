...
;function Pa(a,b){var c=ta(b),d=c?b:arguments;for(c=c?0:1;c<d.length;c++){if(null==a)return;a=a[d[c]]}return a}
...
;var cc=D("Firefox"),dc=(D("Chrome")||D("CriOS"))&&!D("Edge");function F(){this.f=this.f;this.F=this.F}
...
z(Dc,B);Dc.prototype.name="cancel";function I(a){F.call(this);this.j=1;this.h=[];this.i=0;this.b=[];this.g={};this.m=!!a}
...
we.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Ra=u("ytEventsEventsListeners")||{};t("ytEventsEventsListeners",Ra,void 0);var xe=u("ytEventsEventsCounter")||{count:0};t("ytEventsEventsCounter",xe,void 0);function ye(a,b,c,d){d=void 0===d?!1:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Qa(function(e){return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function ze(a,b,c){var d=void 0===d?!1:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=ye(a,b,c,d);if(e)return e;e=++xe.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new we(d);if(!Db(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new we(b);
...
function Ae(a){a&&("string"==typeof a&&(a=[a]),C(a,function(a){if(a in Ra){var b=Ra[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete Ra[a]}}))}
...
function Qe(){window.clearTimeout(Le);if(!Sa(T)){for(var a in T){var b=Je[a];if(!b){var c=Ke[a];if(!c)continue;b=new c;Je[a]=b}c=void 0;var d=a,e=b,f=He[d],g=Ne[d]||{};Ne[d]=g;b=Math.round(L());for(c in T[d]){var h=e.b;h={client:{hl:h.Fa,gl:h.Ea,clientName:h.Da,clientVersion:h.innertubeContextClientVersion}};N("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:N("DELEGATED_SESSION_ID")});h={context:h};h[f]=Pe(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=h[f].length;
h.requestTimeMs=b;var l=Me[c];if(l)a:{var m=h,w=c;if(l.videoId)var G="VIDEO";else if(l.playlistId)G="PLAYLIST";else break a;m.credentialTransferTokenTargetId=l;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:w,scope:G}]}delete Me[c];Se(e,d,h)}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete T[a]}Sa(T)||
Re()}}
...
bf();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Ea(d).toString(36),e=b?bd(b):"",df(d,e,h||5),ef(b))}else h="ST-"+Ea(d).toString(36),d=b?bd(b):"",df(h,d,5),ef(b)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var w=void 0===w?window:w;c=w.location;a=cd(a,l)+m;a=a instanceof E?a:sb(a);c.href=qb(a)}return!0}
...
;function hf(a){a=a||{};this.url=a.url||"";this.args=a.args||Ua(jf);this.assets=a.assets||{};this.attrs=a.attrs||Ua(kf);this.params=a.params||Ua(lf);this.minVersion=a.min_version||"8.0.0";this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
...
function nf(a){var b=new hf,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];b[c]="object"==ra(d)?Ua(d):d}return b}
...
function gg(){Rf();if(!Q("csi_on_gel")){var a=cg(),b=ig().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&sa(a[d])){var e=d.slice(1);if(e in Xf){var f=Ga(a[d],function(a){return Math.round(a-c)});
...
k.C=function(a,b){if(!this.f){var c=tg(this,b);if(c){if(!(0<=Fa(this.ua,a)||this.i[a])){var d=Cg(this,a);this.N&&this.N(a,d)}this.J.subscribe(a,c);"onReady"==a&&this.A&&R(x(c,this.g),0)}}};
...
function Gg(a){var b="player";b=r(b)?Ab(b):b;a=mf(a);var c=Eg+"_"+(b[xa]||(b[xa]=++ya)),d=Dg[c];if(d)return d.ja(a),d.g;d=new og(b,c);Dg[c]=d;Ad("player-added",d.g);ec(d,x(Fg,d));R(function(){d.ja(a)},0);
return d.g}
...
Yg.prototype.l=function(){Ae(this.i);this.b=null;Yg.u.l.call(this)};function Zg(){var a=Pa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||N("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||Q("html5_serverside_pagead_id_sets_cookie")?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=Ua($g);return new H(function(c,d){b.P=function(a){Sd(a)?c(a):d(new ah("Request failed, status="+a.status,"net.badstatus"))};
b.onError=function(){d(new ah("Unknown request error","net.unknown"))};
b.Z=function(){d(new ah("Request timed out","net.timeout"))};
Zd(a,b)})}
var bh={eb:"net.badstatus",fb:"net.retryexhausted",TIMEOUT:"net.timeout",UNKNOWN:"net.unknown"};function ah(a,b){B.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
...
;function gh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof hh;this.isTimeout=a instanceof ch&&a.errorCode==bh.TIMEOUT;this.isCanceled=a instanceof Dc}
n(gh,B);gh.prototype.name="BiscottiError";function hh(){B.call(this,"Biscotti ID is missing from server")}
n(hh,B);hh.prototype.name="BiscottiMissingError";var $g={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},ih=null;function jh(){if("1"===Pa(N("PLAYER_CONFIG",{}),"args","privembed"))return Ac(Error("Biscotti ID is not available in private embed mode"));ih||(ih=Cc(Zg().then(kh),function(a){return lh(2,a)}));
return ih}
...
;function oh(){}
function ph(a){if("1"!==Pa(N("PLAYER_CONFIG",{}),"args","privembed")){a&&!u("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",jh,void 0);try{try{var b=u("yt.ads.biscotti.getId_");var c=b?b():jh()}catch(d){c=Ac(d)}c.then(qh,oh);R(ph,18E5)}catch(d){P(d)}}}
var rh=0;
...
void 0,a.screen?a.screen.availTop:void 0,g,h,l,m];f=window.top||A;try{if(f.document&&!f.document.body)var w=new zb(-1,-1);else{var G=(f||window).document,pd="CSS1Compat"==G.compatMode?G.documentElement:G.body;w=(new zb(pd.clientWidth,pd.clientHeight)).round()}var va=w}catch(Ma){va=new zb(-12245933,-12245933)}w=0;p.SVGElement&&p.document.createElementNS&&(w|=1);va={bc:w,bih:va.height,biw:va.width,brdim:e.join(),vis:{visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Ba.webkitVisibilityState||Ba.mozVisibilityState||
Ba.visibilityState||""]||0,wgl:!!A.WebGLRenderingContext};for(var qd in va)b[qd]=va[qd]}b.bsq=rh++;ee("//www.youtube.com/ad_data_204",{Ca:!1,B:b})}
