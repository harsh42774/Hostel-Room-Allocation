...
else if($r1==$reg || $r2==$reg || $r3==$reg || $r1==$r2 || $r1==$r3 || $r2==$r3)	// This condition is true if the student enters his own key or any 2 keys entered are the same
{
...
else if(abs($rank1-$rank)>200 || abs($rank2-$rank)>200 || abs($rank3-$rank)>200)	// This condition value is true if the rank gap between the students exceed 200
{
